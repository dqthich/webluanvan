                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                            ...
                            ?>
                                <a href="{{URL::to('/unactive-product/'.$pro ->product_id)}}"><span class="fa-thums-styling fa fa-thumbs-up"></span></a>
                            <?php    
                            }else{
                            ?>  
                                <a href="{{URL::to('/active-product/'.$pro ->product_id)}}"><span class="fa-thums-styling fa fa-thumbs-down"></span></a>
                            <?php
                                }    
                            ?>
                        </span></td>
